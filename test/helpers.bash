# -*- bash -*-
 #  The code in this file was take from the netavark repository located at https://github.com/containers/netavark
 #  on the 30.04.23 and comes with the following License
 #
 #  Changes have been made to the detection of the netavark binary, since it is not build inside the repository as it 
 #  is done in the upstream repository
 #
 #                               Apache License
...
NETAVARK=${NETAVARK:-$(which netavark)}
